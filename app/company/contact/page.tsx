...
const faqs = [
  {
    question: "这个模板是免费的吗？",
    answer: "是的，我们的Next.js模板完全开源免费，采用MIT许可证。您可以自由使用、修改和分发。"
  },
  {
    question: "如何获得技术支持？",
    answer: "您可以通过邮件联系我们的技术团队，我们会在24小时内回复。对于开源项目，也可以在GitHub上提交issue。"
  },
  {
    question: "是否提供定制开发服务？",
    answer: "是的，我们提供基于模板的定制开发服务。请通过商务邮箱联系我们，详细说明您的需求。"
  },
  {
    question: "支持哪些技术栈？",
    answer: "我们专注于现代前端技术栈，包括Next.js、React、TypeScript、Tailwind CSS等。具体技术支持请咨询我们的技术团队。"
  }
];
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-blue-500/10 border border-emerald-500/20">
                <SvgIcon icon="lucide:mail" width={20} height={20} className="text-emerald-500" />
                <span className="text-sm font-medium text-muted-foreground">联系我们</span>
              </div>
            ...
            >
              {contactMethods.map((method, index) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.4 + index * 0.1, ...SMOOTH_TRANSITION }}
                ...
                >
                  <div className={cn(
                    ...
                    <SvgIcon icon={method.icon} width={20} height={20} className={method.color} />
                  </div>
                  <h3 className="text-lg font-semibold text-foreground mb-2">{method.title}</h3>
                  <p className="text-sm text-muted-foreground mb-3">{method.description}</p>
                  <p className="text-sm font-medium text-foreground">{method.content}</p>
                </motion.div>
              ))}
            </motion.section>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-4">发送消息</h2>
                  ...
                  <div className="backdrop-blur-xl bg-background/80 border border-border/50 rounded-2xl p-6 shadow-lg space-y-4">
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          <SvgIcon icon="lucide:send" width={16} height={16} className="mr-2" />
                          发送消息
                        </>
                      )}
                    </Button>
                    ...
                    {submitStatus === 'success' && (
                      ...
                      >
                        <SvgIcon icon="lucide:check-circle" width={16} height={16} />
                    ...
                    {submitStatus === 'error' && (
                      ...
                      >
                        <SvgIcon icon="lucide:x-circle" width={16} height={16} />
              ...
              >
                <div>
                  ...
                  <p className="text-muted-foreground">这里是一些常见问题的答案，或许能帮到您。</p>
                </div>
                  ...
                  {faqs.map((faq, index) => (
                    ...
                    >
                      <h3 className="text-lg font-semibold text-foreground mb-3 flex items-center gap-2">
                        <SvgIcon icon="lucide:help-circle" width={18} height={18} className="text-emerald-500" />
                        {faq.question}
                      </h3>
                ...
                <div className="backdrop-blur-xl bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-blue-500/10 border border-border/50 rounded-2xl p-6 shadow-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-3">需要更多帮助？</h3>
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" size="sm" asChild>
                      <Link href="/company/blog">
                        <SvgIcon icon="lucide:book-open" width={16} height={16} className="mr-2" />
                        查看博客
                      </Link>
                    </Button>
                    <Button variant="outline" size="sm" onClick={() => window.open("mailto:support@awt0204.shop", "_blank")}>
