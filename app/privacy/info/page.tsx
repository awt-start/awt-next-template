                  ...
                  <div className="space-y-4">
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <div className="flex items-start gap-3">
                        <span className="w-6 h-6 rounded-full bg-purple-500/20 text-purple-600 text-xs font-bold flex items-center justify-center mt-0.5">
                          1
                        </span>
