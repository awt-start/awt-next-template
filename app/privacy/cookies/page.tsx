...
import { Cookie, Settings, Shield, Eye, Trash2, Clock, Mail, Home, ArrowLeft } from "lucide-react";
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-blue-500/10 border border-emerald-500/20">
                ...
                <span className="text-sm font-medium text-muted-foreground">网站追踪</span>
              </div>
            ...
            >
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-foreground">什么是Cookie</h2>
                </div>
                ...
                <div className="space-y-4 pl-11 text-muted-foreground">
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-r from-emerald-500/5 via-cyan-500/5 to-blue-500/5 border border-emerald-500/20">
                    <div className="space-y-3">
                      <h4 className="font-semibold text-foreground">Cookie的工作原理</h4>
                      <p className="text-sm">
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-foreground">我们使用的Cookie类型</h2>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-border/50 bg-background/30">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-foreground">必要Cookie</h3>
                      </div>
                    ...
                    <div className="p-6 rounded-xl border border-border/50 bg-background/30">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-foreground">分析Cookie</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                    ...
                    <div className="p-6 rounded-xl border border-border/50 bg-background/30">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-foreground">功能Cookie</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                        记住您的选择和偏好，提供个性化体验。
                      </p>
                    ...
                    <div className="p-6 rounded-xl border border-border/50 bg-background/30">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-lg font-semibold text-foreground">第三方Cookie</h3>
                      </div>
                      <p className="text-sm text-muted-foreground mb-3">
                        来自外部服务提供商，用于集成第三方功能。
                      </p>
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-foreground">管理Cookie设置</h2>
                </div>
                ...
                <div className="space-y-4 pl-11">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <h4 className="font-semibold text-foreground mb-2">浏览器设置</h4>
                    ...
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <h4 className="font-semibold text-foreground mb-2">退出分析追踪</h4>
                      <p className="text-sm text-muted-foreground">
                    ...
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <h4 className="font-semibold text-foreground mb-2">Cookie横幅设置</h4>
                      <p className="text-sm text-muted-foreground">
              ...
              <section className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-foreground">第三方服务</h2>
                </div>
                ...
                <div className="space-y-4 pl-11">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      ...
                      <p className="text-xs text-muted-foreground">网站使用情况分析</p>
                    </div>
                    
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <h4 className="font-semibold text-foreground mb-2">CDN服务</h4>
                      <p className="text-xs text-muted-foreground">内容分发网络</p>
                    </div>
                    
                    <div className="p-4 rounded-xl border border-border/50 bg-background/30">
                      <h4 className="font-semibold text-foreground mb-2">字体服务</h4>
                      <p className="text-xs text-muted-foreground">Web字体加载</p>
                    </div>
                  </div>
                </div>
              </section>
                  ...
                  <div className="p-6 rounded-xl bg-gradient-to-r from-violet-500/5 via-purple-500/5 to-pink-500/5 border border-border/30">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-foreground font-medium">邮箱：cookies@awt0204.shop</span>
                      </div>
                      <p className="text-sm text-muted-foreground">
                        我们将在收到您的咨询后3个工作日内回复。
                      </p>
